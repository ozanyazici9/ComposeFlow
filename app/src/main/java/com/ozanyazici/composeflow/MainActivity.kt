...
import com.ozanyazici.composeflow.ui.theme.ComposeFlowTheme
...
fun FirstScreen(viewModel: MyViewModel) {
    ...
    // Flow u burada alıyoruz ve bir başlangıç değeri veriyoruz. XML de çalışsaydık .collect diyeblirdik
    // burada state olarak tutmamızın sebebi recomposition olursa diye.
